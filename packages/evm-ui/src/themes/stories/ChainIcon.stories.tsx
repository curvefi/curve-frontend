...
const meta: Meta<typeof ChainIcon> = {
  ...
  component: ChainIcon,
  argTypes: {
    blockchainId: { control: 'text', description: 'Blockchain network ID used to resolve the icon' },
    size: {
      control: 'select',
      options: ['xxs', 'xs', 'sm', 'md', 'lg', 'xl', 'xxl', '3xl', '4xl'],
      description: 'Responsive icon size token',
    },
    border: { control: 'boolean', description: 'Adds the highlighted badge border and background' },
  },
  args: { blockchainId: 'ethereum', size: 'md', border: false },
}
