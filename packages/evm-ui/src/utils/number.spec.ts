...
describe('formatNumber', () => {
  ...
  describe('categories', () => {
    ...
    it('formats percent categories', () => {
      ...
      expect(formatNumber('1.2', 'percent.price-impact')).toBe('1.2%')
      expect(formatNumber('1.234567', 'percent.price-impact')).toBe('1.23457%')
      expect(formatNumber('0.1234', 'percent.price-impact')).toBe('0.1234%')
