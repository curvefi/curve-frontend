...
export const getFooterSections = (getInternalUrl: (page: typeof PAGE_LEGAL | typeof PAGE_INTEGRATIONS) => string) => [
  {
    title: t`Community`,
    links: [
      { label: t`Twitter`, href: CURVE_SOCIALS.twitter, icon: <XIcon /> },
      { label: t`Discord`, href: CURVE_SOCIALS.discord, icon: <DiscordIcon /> },
      { label: t`Youtube`, href: CURVE_SOCIALS.youtube.en, icon: <YouTubeIcon /> },
      { label: t`Announcements`, href: CURVE_SOCIALS.telegram.announcements, icon: <TelegramIcon /> },
      { label: t`Telegram`, href: CURVE_SOCIALS.telegram.en, icon: <TelegramIcon /> },
      { label: t`Telegram (CN)`, href: CURVE_SOCIALS.telegram.cn, icon: <TelegramCNIcon /> },
      { label: t`Telegram (RU)`, href: CURVE_SOCIALS.telegram.ru, icon: <TelegramRUIcon /> },
    ],
  },
  {
  ...
  },
  {
    title: t`Security`,
    links: [
      { label: t`Audits`, href: EXTERNAL_LINKS.docs.user.security.audits, icon: <BeenhereOutlinedIcon /> },
      { label: t`Bug Bounty`, href: EXTERNAL_LINKS.docs.user.security.bugBounty, icon: <BugReportOutlinedIcon /> },
      { label: t`Curve Monitor`, href: EXTERNAL_LINKS.monitoring.curveMonitor, icon: <LAFIcon /> },
      { label: t`CrvHub`, href: EXTERNAL_LINKS.monitoring.crvHub, icon: <CrvHubIcon /> },
    ],
  },
]
