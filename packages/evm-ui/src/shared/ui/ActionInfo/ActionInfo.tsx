...
import { IconButtonIconSize } from '@evm-ui/themes/components/button'
import { SizesAndSpaces } from '@evm-ui/themes/design/1_sizes_spaces'
import type { TypographyVariantKey } from '@evm-ui/themes/typography'
import { type QueryOrValue, toQuery, toValue } from '@evm-ui/types/util'
      ...
      <Stack direction="row" className="ActionInfo-valueGroup" sx={{ alignItems: 'center', gap: Spacing.xs }}>
        <Stack direction="row" sx={{ alignItems: 'center', gap: Spacing.xs, flexWrap: 'wrap', justifyContent: 'end' }}>
          <Stack direction="row" sx={{ alignItems: 'center', gap: Spacing.xs }}>
            ...
            <Tooltip title={tooltip} placement="top" clickable={!!tooltip} mobileDrawer>
