...
`
console.log(`
  &.mui-sm { width: ${IconSize.sm.mobile}; height: ${IconSize.sm.mobile} }
  ${basicMuiTheme.breakpoints.up('tablet')} {
    &.mui-sm { width: ${IconSize.sm.tablet}; height: ${IconSize.sm.tablet} }
  }
  ${basicMuiTheme.breakpoints.up('desktop')} {
    &.mui-sm { width: ${IconSize.sm.desktop}; height: ${IconSize.sm.desktop} }
  }`)
