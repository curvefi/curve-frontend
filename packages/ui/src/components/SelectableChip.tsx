...
export type SelectableChipProps = { selected: boolean; toggle: () => void; variant?: SelectableChipVariant } & Omit<
  ChipProps,
  'clickable' | 'color' | 'onClick' | 'deleteIcon' | 'variant' | 'onDelete'
>

/** This is needed because the MUI "outlined" variant overrids the custom style in the mui-chip.ts file (e.g. background color) */
const VARIANT_MAP: Record<SelectableChipVariant, ChipProps['variant']> = { outlined: undefined, ghost: 'ghost' }
/**
