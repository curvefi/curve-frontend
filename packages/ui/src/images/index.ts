...
export { ReactComponent as RCGithubLogo } from './github.svg'
...
export { ReactComponent as RCSun } from './sun.svg'

// APP
export { ReactComponent as RCCheck } from './check.svg'
export { ReactComponent as RCCircle } from './circle.svg'
export { ReactComponent as RCCross } from './cross.svg'
export { ReactComponent as RCEditClear } from './edit-clear-symbolic.svg'
export { ReactComponent as RCExternal } from './external.svg'
export { default as LlamaImg } from './llama.png'
