...
export const Primary: Story = { parameters: { docs: { description: { story: 'Primary radio button' } } } }

export const Secondary: Story = {
  args: { color: 'secondary' },
  parameters: { docs: { description: { story: 'Secondary radio button' } } },
}

export const Small: Story = {
  args: { size: 'small' },
  parameters: { docs: { description: { story: 'Small-sized radio button (xs)' } } },
}

export const Medium: Story = {
  args: { size: 'medium' },
  parameters: { docs: { description: { story: 'Medium-sized radio button (sm)' } } },
}

export const Large: Story = {
  args: { size: 'large' },
  parameters: { docs: { description: { story: 'Large-sized radio button (md)' } } },
}

export const Disabled: Story = {
  args: { disabled: true },
  parameters: { docs: { description: { story: 'Disabled radio button' } } },
}

export const Unchecked: Story = {
  args: { checked: false },
  parameters: { docs: { description: { story: 'Unchecked radio button' } } },
}
