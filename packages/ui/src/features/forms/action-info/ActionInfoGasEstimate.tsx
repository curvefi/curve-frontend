...
export type TxGasInfo = { estGasCostUsd?: Amount; nativeCost?: { amount: Amount; symbol: string }; tooltip?: string }
  ...
  <ActionInfo
    ...
    value={mapQuery(
      ...
      data =>
        ...
        maybe(data?.nativeCost, ({ amount, symbol }) => `${formatNumber(amount, 'token.amount')} ${symbol}`), // todo use formatToken
    )}
