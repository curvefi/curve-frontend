...
runEndpointCases('revenue', [
  ...
  endpointCase('getDistributions', 'options', () => revenue.getDistributions(requestOptions)),
  endpointCase('getDistributionsPage', () => revenue.getDistributionsPage({ per_page: 10 }, requestOptions)),
