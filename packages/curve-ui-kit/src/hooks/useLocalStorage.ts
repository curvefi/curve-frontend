...
export const setLocalStorage = <Type>(storageKey: string, value: Type) =>
  value == null
...
const useLocalStorage = <Type, Default = Type>(key: string, initialValue?: Default) =>
  useStoredState<Type, Default>({
    ...
    set: (storageKey: string, value: Type | Default) => setLocalStorage<Type | Default>(storageKey, value),
  })
...
export const useWalletName = () => useLocalStorage<string | null>(WalletNameStorageKey, null)
