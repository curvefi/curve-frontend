...
export interface ChainQuery<T = number> { chainId: T }
export interface UserQuery<T = Address> { userAddress: T }
export interface ChainNameQuery<T = Chain> { blockchainId: T }
