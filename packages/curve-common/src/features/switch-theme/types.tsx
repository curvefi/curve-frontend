...
export const themes = [
  {
    type: 'light',
    Component: ({ size = DEFAULT_SIZE }: { size?: number }) => <RCSun width={size} aria-label="Light theme" />,
  },
  {
    type: 'dark',
    Component: ({ size = DEFAULT_SIZE }: { size?: number }) => <RCMoon width={size} aria-label="Dark theme" />,
  },
  {
    type: 'chad',
