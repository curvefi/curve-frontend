...
import { GaugeQueryKeyType, type GaugeQueryParams, type PoolMethodResult } from '@/entities/gauge/types'
...
export const queryGaugeStatus = async ({ poolId }: ValidatedData<GaugeQueryParams>) => {
