...
export const useBridgeForm = ({
  ...
  return {
    ...
    layerZeroCapacityAvailable: isLayerZero ? layerZero.capacityAvailable : undefined,
    layerZeroCapacityExceeded: isLayerZero && layerZero.capacityExceeded,
    layerZeroCapacityError: isLayerZero ? layerZero.capacityError : undefined,
    layerZeroCapacityLoading: isLayerZero && layerZero.capacityLoading,
