...
const TOKEN_ALERTS: Record<string, PoolAlert> = {
  ...
  '0x36f8d0d0573ae92326827c4a82fe4ce4c244cab6': MA_ALERT,
  '0xa5269a8e31b93ff27b887b56720a25f844db0529': MA_ALERT,
  '0xafe7131a57e44f832cb2de78ade38cad644aac2f': MA_ALERT,
...
const getTokenAlertByAddress = (tokenAddress: string) => TOKEN_ALERTS[tokenAddress.toLowerCase()] ?? null

const getTokenAlert = (tokenAddressAll: readonly string[] | undefined): PoolAlert | null =>
  notFalsy(...(tokenAddressAll ?? []).map(getTokenAlertByAddress))[0] ?? null

export const useTokenAlert = (tokenAddressAll: readonly string[] | undefined): PoolAlert | null =>
  useMemo(() => getTokenAlert(tokenAddressAll), [tokenAddressAll])
