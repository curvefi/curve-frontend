...
// prettier-ignore
const TOKEN_LINKS: PartialRecord<ChainId, Record<string,  Record<Address, string>>> = {
  250: {
    'factory-stable-ng-24': ({
...
export const usePoolTokensLinksMapper = (rChainId: ChainId, { pool }: PoolDataCacheOrApi) =>
  useMemo(() => TOKEN_LINKS[rChainId]?.[pool?.id], [rChainId, pool?.id])
