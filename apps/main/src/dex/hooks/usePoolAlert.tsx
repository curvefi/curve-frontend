...
const yPrismaAlert = (): PoolAlert => {
  ...
  return {
    ...
    banner: {
      ...
      subtitle: (
        <Trans>
          This pool has been deprecated. Please use the <InlineLink to={prismaPoolHref}>PRISMA/yPRISMA</InlineLink> pool
          instead.
        </Trans>
      ),
    },
...
const synthetixAlert = (): PoolAlert => ({
  ...
  message: (
    <PoolAlertMessage>
      ...
      <p>
        <Trans>
          Users are encouraged to exit the pools in order to avoid getting their holdings&lsquo; value diluted with the
          discountRate For more information please refer to{' '}
