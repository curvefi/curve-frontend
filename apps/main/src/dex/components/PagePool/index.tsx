import type {
  ...
  Slippage,
  TransferFormType,
} from '@main/components/PagePool/types'
import { t } from '@lingui/macro'
import { useCallback, useEffect, useMemo, useState } from 'react'
import styled from 'styled-components'
import { REFRESH_INTERVAL, ROUTE } from '@main/constants'
...
import Deposit from '@main/components/PagePool/Deposit'
import PoolStats from '@main/components/PagePool/PoolDetails/PoolStats'
import Swap from '@main/components/PagePool/Swap'
import MySharesStats from '@main/components/PagePool/UserDetails'
import Withdraw from '@main/components/PagePool/Withdraw'
...
import CampaignRewardsBanner from '@main/components/PagePool/components/CampaignRewardsBanner'
import PoolInfoData from '@main/components/PagePool/PoolDetails/ChartOhlcWrapper'
import PoolParameters from '@main/components/PagePool/PoolDetails/PoolParameters'
import { useGaugeManager } from '@main/entities/gauge'
import { BlockSkeleton } from '@ui/skeleton'
import { ManageGauge } from '@main/widgets/manage-gauge'
