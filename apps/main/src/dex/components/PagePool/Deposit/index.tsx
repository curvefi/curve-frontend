import type { FormType } from '@main/components/PagePool/Deposit/types'
...
import { DEFAULT_FORM_STATUS } from '@main/components/PagePool/Deposit/utils'
import { StyledTabSlide } from '@main/components/PagePool/styles'
import { SlideTab, SlideTabs } from '@ui/TabSlide'
import AlertBox from '@ui/AlertBox'
import FormDeposit from '@main/components/PagePool/Deposit/components/FormDeposit'
import FormDepositStake from '@main/components/PagePool/Deposit/components/FormDepositStake'
import FormStake from '@main/components/PagePool/Deposit/components/FormStake'
