import type { DashboardTableRowProps, FormValues, TableLabel } from '@main/components/PageDashboard/types'
...
import { DashboardContextProvider } from '@main/components/PageDashboard/dashboardContext'
import { breakpoints } from '@ui/utils'
import { getPath } from '@main/utils/utilsRouter'
import curvejsApi from '@main/lib/curvejs'
import useStore from '@main/store/useStore'
import ClassicPoolsOnlyDescription from '@main/components/PageDashboard/components/ClassicPoolsOnlyDescription'
import Spinner, { SpinnerWrapper } from '@ui/Spinner'
import Summary from '@main/components/PageDashboard/components/Summary'
import Table from '@ui/Table'
import TableHead from '@main/components/PageDashboard/components/TableHead'
import TableHeadMobile from '@main/components/PageDashboard/components/TableHeadMobile'
import TableRow from '@main/components/PageDashboard/components/TableRow'
import TableRowMobile from '@main/components/PageDashboard/components/TableRowMobile'
import TableRowNoResult from '@main/components/PageDashboard/components/TableRowNoResult'
import TableSortDialog from '@main/components/PageDashboard/components/TableSortDialog'
import { getDashboardDataActiveKey } from '@main/store/createDashboardSlice'
