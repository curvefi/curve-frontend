...
const DEFAULT_ZAPV2_MARKET_CONFIG = { providers: ['enso'] } satisfies ZapV2MarketConfig

export const ZAPV2_MARKET_CONFIG: PartialRecord<number, Record<Address, ZapV2MarketConfig>> = {
  [Chain.Ethereum]: {
    '0xcaD85b7fe52B1939DCEebEe9bCf0b2a5Aa0cE617': DEFAULT_ZAPV2_MARKET_CONFIG, // WBTC-long
    '0x23F5a668A9590130940eF55964ead9787976f2CC': DEFAULT_ZAPV2_MARKET_CONFIG, // WETH-long2
    '0x5756A035F276a8095A922931F224F4ed06149608': DEFAULT_ZAPV2_MARKET_CONFIG, // wstETH-long2
    '0xB4544e705665e0856961a51F7E86Ccf633404b86': DEFAULT_ZAPV2_MARKET_CONFIG, // XAUM-long
    '0xFd85e847cDd2549f213E276e4B57B0690169F043': DEFAULT_ZAPV2_MARKET_CONFIG, // svZCHF-crvUSD v2
    '0x652aEa6B22310C89DCc506710CaD24d2Dba56B11': DEFAULT_ZAPV2_MARKET_CONFIG, // weETH Mint
    '0xf8C786b1064889fFd3c8A08B48D5e0c159F4cBe3': DEFAULT_ZAPV2_MARKET_CONFIG, // cbBTC Mint
    // syrupUSDC-crvUSD
    '0x2fb54c8eae57767A9A509A395b9C4FA0702e2675': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    // sfrxUSD-crvUSD v2
    '0x3cD4d86a2c65e57ce4b4121b67E2D2224BA41bbe': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    // sDOLA-crvUSD v2
    ...
    // sreUSD-crvUSD
    '0x4F79Fe450a2BAF833E8f50340BD230f5A3eCaFe9': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    // fxSAVE-crvUSD
    '0x8035b16053560b3C351b665b10f6C7dBDb6A1E05': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    // sUSDS-crvUSD
    '0x2dA313f6DCEE04BA46466E100c4656618E5d3dDd': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    // sfrxUSD-crvUSD
    '0x3DE37c38739dFb83b7A902842bF5393040f7BF50': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    // sUSDe-crvUSD
    ...
    '0x4f87158350c296955966059C50263F711cE0817C': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x74f88Baa966407b50c10B393bBD789639EFfE78B': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x8C2537F1a5b1b167A960A14B89f7860dd5F7cD68': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x3c1350aa6FaFF17c87Bde2015BBb45100D37dAD3': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xCf3DF6C1B4A6b38496661B31170de9508b867C8E': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xAC9AdD93364Aea685be238dB6c40BF53753f2cF1': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x1F9D988cDeBfA1FD5563C122a987186e516173c2': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xDC8b1Caf2e10dE76fb67E82C2485E7d4fA098C53': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x276B8C8873079eEACCF4Dd241De14be92D733b45': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xdC5D5EE1223D4C8b7eAc8e876793f2171e7e8dEb': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x143985860EFaeAcB92Db23E4b0c4d66Be51b08D2': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x757C61d89bD0406BfcBB68178BBfaE79ECa46c0f': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xC28C2FD809FC1795f90de1C9dA2131434A77721d': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xf8C27436B277734AAA726A8fD5e6D7daDe0296c5': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x6f91f33Ac7122F025b73206239CbC81606F022D4': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xaD444663c6C92B497225c6cE65feE2E7F78BFb86': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xc572297c5e995692B972c8eEa1D12b56b6399e1e': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xD961B0Da2B0Fb04439c96B552777720B5FC551A0': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x89707721927d7aaeeee513797A8d6cBbD0e08f41': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x24174143cCF438f0A1F6dCF93B468C127123A96E': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xB62B9272679d7A495d7e9698d8663F217224408a': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xE786af7faef857C8D850d648723Eec0A27cd8581': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x5bfEE37053d711F49A0aCf5afEd6496fA68dCE32': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xFA4f65B3Dc477738ce8618e9145E1f0Ad9E29034': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xbe0f8c48776c0433B2b778AE9c076C21683ebe7B': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xbCc9AcD2E7934bb8B5d734416737694AcDD9E25a': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xd15d9797c4ECBf1c97c010327602bC51A09Dfb95': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x6934ba5ED7B1664F9e04161D7d76291C3f9D8C21': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x1591F867C42ecA199d59a4f8B0074DeDee5D843A': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x9E1A39B16FE4d56C275998189B08953898BED048': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x8aca5A776a878Ea1F8967e70a23b8563008f58Ef': DEFAULT_ZAPV2_MARKET_CONFIG,
  },
  [Chain.Optimism]: {
    // wstETH-WETH v2
    ...
    '0x9fC15ac3EF97093832f49B7997A58E29b49C56dE': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xb5EC7A3D591877A66BE4f3eafdC4205E98A1BCAA': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x9dba46e6a06FBf24CA11f8912B44338fe1b28Ea9': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x6CE5B539367A29d48038A9F3108E6e0f226b83ed': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x09cEd8b3392bED73B0358e39AaEC0A6e9b0e76DF': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xC5Cd9f6A1Fb88bed782f475F72fF686ED35b7e8e': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x88aa928B906b745009B53A31034701Fc377b7C89': DEFAULT_ZAPV2_MARKET_CONFIG,
  },
  [Chain.Fraxtal]: {
    // sfrxUSD-crvUSD
    '0xB4EbF87A474569d8eB7f7182B4beBD8aE79ae675': {
      ...DEFAULT_ZAPV2_MARKET_CONFIG,
      slippage: SLIPPAGE.stable.default,
    },
    '0xc68f91FfA2B27147F9AB153267018f5Fe4b6850F': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xf0922934f16DbE5Df9f90F729b2023D5e1FC2F15': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x99d5b47D431f1963940F72ffa6F25bC0B9849CbF': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xBF55Bb9463bBbB6aD724061910a450939E248eA6': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xCdf0D2a3B4e8D334042aE04631137696C7a09a00': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x1d174AdBF69D531EE13629a253517Ad3Cf3Aa7AF': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xCB2b1f2a5d472828eB56d36E9Bdbefb4963ECA79': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xc52eFB33C8b90d7c1f64c4b5747ae209af2A02e5': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xCadF8A2Aa79eb80DDFcD204C50E3c7d6d3ed1927': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x5B425D2a3D9bea2B3a158125b15895D9C34dCFb2': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x03F98Bcf2A602cBe165Ddc14b2b0B20139A660d2': DEFAULT_ZAPV2_MARKET_CONFIG,
  },
  [Chain.Sonic]: {
    '0x5eD490a9B71fa797231d2c5D9bE25bf91a953C19': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xB8C93fb97884Ea07c2Eb0eA741f78D10e8C5aF9F': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xDC06056e208aB92bF173FF6DD662F1018ea0E483': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x7547E577B3DDC23c02E10792457f8e51a225692E': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xbb7A0C558Fd34234Dc1608f4CD0a334E0075D73a': DEFAULT_ZAPV2_MARKET_CONFIG,
  },
  [Chain.Arbitrum]: {
    '0xB5c6082d3307088C98dA8D79991501E113e6365d': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xb9aDddCf4e01c2f64F8F2CD9a050DC35585ea053': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xeCF99dE21c31eC75b4Fb97e980F9d084b1d8Da8f': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0xF4e35f69D0BeE1AFC26EE73f12Fa7fA220F16F40': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x83B85f3b08B5EE58dE9EF9604e7Eec087FCCf130': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x991Bf50A34972227e681127D9127a1Dc54f67a3b': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x3e293dB65c81742e32b74E21A0787d2936beeDf7': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x4153532Eb32D57a1a08cD024c66E79635aFC8e3a': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x376e6D52F38e0fCe8E94293ce911e2FdEd2d4A4f': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x5A2b666E6f36CB0a17CF03c9feb421855Ca9751D': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x398e6dd92Df9F792D0107668871e6F49ebdfE028': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x6c1cD25cC6320f992EDE07F6a6e93810e8855bc2': DEFAULT_ZAPV2_MARKET_CONFIG,
    '0x7a5A1c91dAF5A41942F90b3f8a9c4d3526294c16': DEFAULT_ZAPV2_MARKET_CONFIG,
  },
}
