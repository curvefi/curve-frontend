...
export const validateUserCollateral = (userCollateral: Decimal | undefined | null, required: boolean = false) => {
  test(
    'userCollateral',
    `Collateral amount must be a ${required ? 'positive' : 'non-negative'} number`,
    () => {
