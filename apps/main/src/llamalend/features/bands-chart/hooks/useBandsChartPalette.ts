...
export const useBandsChartPalette = (): BandsChartPalette => {
  ...
  return useMemo(
    () => ({
      ...
      userCollateralShareColor: theme.design.Chart.Lines[1],
      userBorrowedShareColor: theme.design.Chart.Lines[2],
      userRangeBackgroundColor: theme.design.Chart.LiquidationZone.Current,
      userRangeTopLineColor: theme.design.Chart.LiquidationZone.TopLine,
      userRangeBottomLineColor: theme.design.Chart.LiquidationZone.BottomLine,
