 ...
 */
type MutationFnContext<TMarket extends LlamaMarketTemplate> = {
...
type LlammaMutationOptions<TMarket extends LlamaMarketTemplate, TVariables, TData, TContext extends Context> = {
 ...
 */
export function useLlammaMutation<TMarket extends LlamaMarketTemplate, TVariables, TData, TContext extends Context>({
  market,
  mutationKey,
  mutationFn,
  pendingMessage,
