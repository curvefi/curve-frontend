...
const usePoolAlert = (poolAddress: string | undefined, hasVyperVulnerability: boolean | undefined) => {
  ...
  return useMemo(() => {
    ...
    const alerts: { [poolAddress: string]: PoolAlert } = {
      ...
      '0x9a5f6843c672e96c9b3c3e190b060f0809745402': crossCurveAlert([{label: 'Mint s-tokens', url: 'https://app.crosscurve.fi/liquidity?pool=0x9a5f6843c672e96c9b3c3e190b060f0809745402&action=deposit&type=curve'}, {label: 'Redeem s-tokens', url: 'https://app.crosscurve.fi/liquidity?pool=0x9a5f6843c672e96c9b3c3e190b060f0809745402&action=withdraw&type=curve'}, {label: 'Cross-chain swap', url: 'https://app.crosscurve.fi/swap?inputChainId=53&inputToken=0x29219dd400f2bf60e5a23d13be72b486d4038894&outputChainId=51&outputToken=0xd988097fb8612cc24eec14542bc03424c656005f' }]), // CrossCurve xStable3
