    ...
    <Card>
      ...
      <CardContent sx={{ position: 'relative' }}>
        <Stack gap={Spacing.xs}>
          ...
          <Typography>
            <Trans>
              Total crvUSD in circulation (Supply) versus the amount actively borrowed against collateral (Borrowed).
              The gap between the two lines reflects Pegkeeper debt — crvUSD minted by the protocol to stabilize the
              peg, not backed by user collateral.
            </Trans>
          </Typography>
        </Stack>
      </CardContent>
