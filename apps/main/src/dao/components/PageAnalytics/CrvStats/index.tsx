...
import { CRV_ADDRESS, type CrvChain, formatNumber } from '@ui-kit/utils'
...
export const CrvStats = () => {
  ...
  const { data: crv, isFetching: isLoadingCrv } = useTokenUsdRate({
    chainId,
    tokenAddress: CRV_ADDRESS[chainId as CrvChain],
  })
