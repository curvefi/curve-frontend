...
import type { FilterKey, SearchParams } from '@/lend/components/PageMarketList/types'
...
const SelectFilter = ({
  ...
  <Select
    ...
    onSelectionChange={(filterKey) => updatePath({ filterKey: (filterKey as FilterKey) || undefined })}
