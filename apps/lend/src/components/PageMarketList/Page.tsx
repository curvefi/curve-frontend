...
const Page: NextPage = () => {
  ...
  const TABLE_LABELS_MAPPER: TableLabelsMapper = {
    ...
    cap: { name: t`Total supplied` },
    utilization: { name: t`Utilization %` },
    capUtilization: { name: t`Total supplied Utilization %` },
    ...
    totalCollateralValue: { name: t`Total collateral value` },
    totalDebt: { name: t`Total debt` },
