...
import type { FormValues, FormStatus, StepKey } from '@loan/components/PageLoanManage/CollateralDecrease/types'
...
import { StyledInpChip, StyledDetailInfoWrapper } from '@loan/components/PageLoanManage/styles'
