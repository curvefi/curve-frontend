...
import type { FormValues, FormStatus, StepKey } from '@/components/PageLoanManage/CollateralDecrease/types'
...
import { DEFAULT_FORM_STATUS } from '@/store/createLoanCollateralDecreaseSlice'
