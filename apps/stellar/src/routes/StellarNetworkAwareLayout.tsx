import { asAddress, shortenAddress } from '@/stellar/features/connect-wallet/address'
import { StellarConnectModal } from '@/stellar/features/connect-wallet/StellarConnectModal'
