...
describe('Refuel page', () => {
  ...
  it('renders the crvUSD/WETH refuel dashboard and disconnected form state', () => {
    ...
    getTestById('pool-information', API_LOAD_TIMEOUT).should('be.visible')
    getTestById('pool-tvl-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    getTestById('pool-volume-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    getTestById('pool-fees-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    getTestById('pool-apr-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)

    getTestById('prices-chart', API_LOAD_TIMEOUT).should('be.visible')
    getTestById('lp-token-value-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    getTestById('virtual-price-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    ...
    getTestById('budget-chart', API_LOAD_TIMEOUT).should('be.visible')
    getTestById('shares-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    getTestById('duration-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    getTestById('max-ratio-value', API_LOAD_TIMEOUT).invoke('attr', 'data-value').should('match', /\d/)
    ...
    getTestById('reserves-composition-chart', API_LOAD_TIMEOUT).should('be.visible')
    ...
    getTestById('daily-refuels-chart', API_LOAD_TIMEOUT).should('be.visible')
    ...
    getTestById('recent-refuels', API_LOAD_TIMEOUT).should('be.visible')
